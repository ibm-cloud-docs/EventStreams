...
1. {: #footnote_szr notoc} For more information about availability, see [single zone location (SZR)](/docs/services/EventStreams?topic=eventstreams-plan_choose#footnote_plans).

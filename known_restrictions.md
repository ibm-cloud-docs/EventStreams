...
A Kafka Improvement Proposal (KIP) #302 (available as option from Kafka 2.1.1 and by default from 2.6.0) ensures that Kafka clients try all available broker IP addresses 

...
| --- | --- | --- | --- |
| Allow full access to all resources. | ![Checkmark icon.](images/confirm.png "Feature available")  Not applicable  | Not applicable  | Service instance: <your_service_instance> |

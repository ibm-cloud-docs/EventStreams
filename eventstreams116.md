...
You can find these console tools in the <code>bin</code> directory of your Kafka download. For example, [Apache Kafka 1.1.1 client binary download ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://archive.apache.org/dist/kafka/1.1.1/kafka_2.11-1.1.1.tgz){:new_window}.

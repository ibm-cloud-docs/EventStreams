...
{: #connect_enterprise_plan_cf_console}
...
{: #connect_enterprise_plan_cf_cli}
...
{: #connect_enterprise_plan_external}
...
### Get credentials using the IBM Cloud console
{: #connect_enterprise_plan_external_console}
...
### Get credentials using the IBM Cloud CLI
{: #connect_enterprise_plan_external_cli}

...
* **Kafka's core API (Consumer, Producer, and Admin API)**<br/>
	...
	The Kafka Admin client provides a simple interface through the Kafka API for creating, deleting, and managing topics. You can also use the Admin client to manage brokers and configurations.
* **Streams API**<br/>

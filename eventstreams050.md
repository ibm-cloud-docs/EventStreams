...
* **Kafka's core API (Consumer, Producer, and Admin API)**<br/>
    Use to send and receive messages directly from one or more Kafka topics. The Kafka Admin Client provides a simple HTTPS interface for creating, deleting, and managing topics, in addition to managing brokers and configurations.
* **Streams API**<br/>

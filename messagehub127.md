...
<li>Find your app by running the following command: ```ibmcloud app list```. If you have a manifest file, you can create a new app by running <code>ibmcloud app push</code>
</li>
<li>Find your service: <code>ibmcloud service list</code>
</li>
<li>Issue the bind call: <code>ibmcloud service bind <var class="keyword varname">your_app_name</var> <var class="keyword varname">your_service_name</var></code>
</li>
<li>Verify that the VCAP_SERVICES environment variable is available in your application runtime. You can do this by calling <code>ibmcloud app env <var class="keyword varname">your app's name</var></code>. You might need to restage your application for the changes to take effect.
	You need to make sure the application parses this from the environment.
</li>	
</ol>

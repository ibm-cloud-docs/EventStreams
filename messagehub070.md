...
* [{{site.data.keyword.messagehub}} Administration API](/docs/services/EventStreams/eventstreams037.html)
{:shortdesc}


## The __consumer_offsets topic in the Enterprise plan

The internal Kafka ```__consumer_offsets``` topic is visible to you if you're using the Enterprise plan. You are strongly recommended not to attempt to delete or manage the topic in any way. 

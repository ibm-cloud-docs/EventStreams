...
## What the restrictions and defaults for topics and partitions?
{: #topics_partitions}
{: faq}
...
You can use a tool like Kafka MirrorMaker to replicate data between clusters. For information about how to build the Docker image, see 
[{{site.data.keyword.messagehub}} kafka-mirrormaker sample ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://github.com/ibm-messaging/event-streams-samples/tree/master/kafka-mirrormaker){:new_window}.

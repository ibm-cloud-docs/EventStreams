...
## How do I clean up a consumer group with no consumers?
{: #clean_consumer_group}
{: faq}

Consumer offsets are deleted after 7 days of inactivity. After consumers have left, a group exists only if it has offsets.

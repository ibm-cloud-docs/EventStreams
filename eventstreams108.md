...
You are strongly recommended not to attempt to manage the topic in any way.  You cannot access the <code>__consumer_offsets</code> topic at all on the Standard plan.

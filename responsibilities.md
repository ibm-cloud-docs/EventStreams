...
|Cluster management| {{site.data.keyword.messagehub}} deploys a service instance and cluster consisting of all required {{site.data.keyword.messagehub}} components onto the customer provided infrastructure. {{site.data.keyword.messagehub}} is responsible for monitoring the health of the {{site.data.keyword.messagehub}} cluster and recovery of that cluster, unless recovery requires customer infrastructure actions. | Customer is responsible for managing the provided resource capacity of their clusters across their organizational user base. |

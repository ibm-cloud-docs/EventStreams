...
# Release notes for {{site.data.keyword.messagehub}} Gen 1
...
For more information on how to migrate your encryption keys, see [Migrating from {{site.data.keyword.hscrypto}} (HPCS) to {site.data.keyword.keymanagementserviceshort}} Dedicated (KP-ST)](/docs/EventStreams?topic=EventStreams-managing_encryption#migrating_hpcs_to_kp).

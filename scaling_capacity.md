...
The number of Kafka brokers can change as throughput is scaled. Clients automatically utilize these additional brokers without configuration changes or restarting, the list of bootstrap servers does not need to be changed. However, be aware of the following: 

...
For backward compatibility, you can use the Apache Kafka V0.9 Java client with the {{site.data.keyword.messagehub}} Standard plan. However, because of this client's age, we strongly discourage its use. 

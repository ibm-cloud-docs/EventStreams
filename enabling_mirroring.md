...
When you are building a solution involving mirroring in {{site.data.keyword.messagehub}}, you should consider how your solution will deal with the following scenarios:

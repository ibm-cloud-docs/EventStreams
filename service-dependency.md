...
|:---|:---|:---|:---|:---|
|  [IBM Cloud Block Storage](/docs/classic-block-storage?topic=classic-block-storage-service-dependencies)  | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same data center  |
|  [IBM Cloud Object Storage (IaaS)](/docs/cloud-object-storage-infrastructure?topic=cloud-object-storage-infrastructure-service-dependencies)  | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same data center  |
...
|  [IBM Cloud Object Storage](/docs/cloud-object-storage?topic=cloud-object-storage-service-dependencies)  | Availability, Change management, Disaster recovery, Instance control | No | Both |  [Global](https://cloud.ibm.com/docs/overview?topic=overview-zero-downtime#global-platform)  |
...
|  [IBM Cloudant for IBM Cloud](/docs/Cloudant?topic=Cloudant-service-dependencies)  | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
...
|Dependencies|Dependency impacts|Customer provided|Control or data plane|Location of dependency|
|:---|:---|:---|:---|:---|
|  [IBM Cloud Secrets Manager](/docs/secrets-manager?topic=secrets-manager-service-dependencies)  | Availability, Change management, Disaster recovery, Instance control, Security compliance | No | Both |  Same region  |

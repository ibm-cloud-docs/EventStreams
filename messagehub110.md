...
1. Create a {{site.data.keyword.messagehub}} KSQL configuration file.
    ...
    ```
    Ensure that you edit the ```sasl.jaas.config``` line to insert your own username and password pair. 
...
--<var class="keyword varname">messagehub-ksql-properties-file</var> ./config/ksqlserver.properties
</pre>

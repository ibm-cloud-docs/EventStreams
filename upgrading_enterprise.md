...
|  **Location (region) availability** | Various  |  **Multizone location (MZR)** Dallas (us-south) Washington (us-east) London (eu-gb) Sydney (au-syd) Frankfurt (eu-de) Tokyo (jp-tok)

**Single zone location (SZR)** Seoul (seo01) Chennai (che01) |
...
| **Compliance** |GDPR Privacy Shield ISO 27001, 27017, 27018 |  GDPR
Privacy Shield
